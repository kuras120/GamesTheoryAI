...
| Theme behavior, FXML, styling, or presentation infrastructure | `docs/guidelines/engineering-guide.md` plus a game domain document only when game behavior is affected |
